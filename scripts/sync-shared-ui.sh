...
sed '/^export /d' "$ROOT/shared/analyze-client.js" > "$ROOT/extension/lib/analyze-client.js"
echo "→ extension/lib/report-view.js"
echo "→ extension/lib/analyze-client.js"
...
if [[ -d "$GLOW/src" ]]; then
  ...
  cp "$ROOT/shared/analyze-client.js" "$GLOW/src/lib/analyze-client.js"
  ...
  echo "→ vision-job-glow/src/lib/analyze-client.js"
